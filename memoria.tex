...
\director{Dr. Lic. Pablo Ventura (UNC-KeyLab)} % El nombre del director, se usa en la carátula y se puede usar el cualquier lugar del documento con el comando \dirname
